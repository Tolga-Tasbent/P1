Shader "unityCookie/Beginner/7 - Normal Map" {
	Properties{
		_Color ("Color Tint", Color) = (1.0,1.0,1.0,1.0)
		_MainTex("Diffuse Texture", 2D) = "white" {}
		_BumpMap("Normal Texture", 2D) = "bump" {}
		_BumpDepth("Bumb depth", Range(-2.0, 2.0)) = 1.0 
		...
		SubShader{
			...
			float4 frag(vertexOutput i) : COLOR 
			{
				...
				//localCoords.z = 1.0 - 0.5 * dot(localCoords, localCoords); // other option than _BumbDepth
